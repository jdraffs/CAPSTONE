...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  async function processAllAnalytics() {
    ...
    for (let index = 0; index < uploadedFiles.length; index++) {
      ...
      try {
        // Fetch saved interpretation from database
        ...
        reports.push({
          ...
          interpretation: savedInterpretation || "No AI interpretation available yet. Contact the data manager to generate one.",
  ...
  window.viewReportDetails = function(reportId) {
    ...
    detailsContainer.innerHTML = `
      ...
      <!-- Read-Only Notice -->
      <div class="access-banner read-only" style="margin: 20px 0;">
        <i class="fas fa-info-circle"></i>
        <div>
          <strong>Read-Only Access:</strong>
          <span>You can view this report but cannot modify data or generate new AI interpretations.</span>
        </div>
      </div>
      ...
      <div class="modal-interpretation ${report.hasInterpretation ? 'has-ai' : 'no-ai'}">
        ...
        <div class="interpretation-content">
          ${report.hasInterpretation 
            ...
            : '<p class="no-interpretation"><i class="fas fa-info-circle"></i> No AI interpretation has been generated for this report yet. Contact the data manager to request an AI analysis.</p>'}
        </div>
